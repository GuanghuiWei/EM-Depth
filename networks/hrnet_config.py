...
HRNET_64.STAGE1 = CN()
HRNET_64.STAGE1.NUM_MODULES = 1
HRNET_64.STAGE1.NUM_BRANCHES = 1
HRNET_64.STAGE1.NUM_BLOCKS = [4]
HRNET_64.STAGE1.NUM_CHANNELS = [64]
HRNET_64.STAGE1.BLOCK = 'BOTTLENECK'
HRNET_64.STAGE1.FUSE_METHOD = 'SUM'
